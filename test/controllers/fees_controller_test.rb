...
class FeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fee" do
    assert_difference('Fee.count') do
      post fees_url, params: { fee: { deposit_date: @fee.deposit_date, deposite_fee: @fee.deposite_fee, student_id: @fee.student_id, total_fee: @fee.total_fee } }
    end
  ...
  test "should update fee" do
    patch fee_url(@fee), params: { fee: { deposit_date: @fee.deposit_date, deposite_fee: @fee.deposite_fee, student_id: @fee.student_id, total_fee: @fee.total_fee } }
